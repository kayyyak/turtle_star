...
: ${AMENT_CURRENT_PREFIX:="/home/kaymarrr/fra501_ws/install/turtlesim_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/turtlesim_control/environment/pythonpath.sh"
